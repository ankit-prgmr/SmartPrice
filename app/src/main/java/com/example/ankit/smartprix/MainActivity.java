...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = (ListView) findViewById(R.id.List);
        ...
        Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                .appendQueryParameter(TYPE, "categories")
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            jarr = response.getJSONArray("request_result");
                            ArrayList<String> categories = new ArrayList<>();

                            for(int i=0 ; i<jarr.length() ; i++)
                                categories.add(jarr.getString(i));

                            listAdapter = new ArrayAdapter<String>(MainActivity.this , R.layout.simplerow , categories);
                            ...
                            category.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    Intent i  = new Intent(MainActivity.this , Prod_list.class);
    ...
    protected void handleMenuSearch(){
        ...
        if(isSearchOpened){ //test if the search is open
            ...
            mSearchAction.setIcon(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_search));
            ...
            mSearchAction.setIcon(ContextCompat.getDrawable(MainActivity.this, R.drawable.ic_close_search));
